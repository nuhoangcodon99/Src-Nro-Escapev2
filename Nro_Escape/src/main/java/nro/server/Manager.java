...
public class Manager {
    ...
    public static Timestamp timeSuKienDuaTop = Timestamp.valueOf("2024-06-24 23:59:59");

    public static String timeStartDuaTop = "11h ngày 25/6/2024";

    public static String timeEndDuaTop = "23h59 ngày 30/7/2024";

    public static String timeEndNhanGiai = "30/7/2024";

    public static String SERVER_NAME = "Ngọc rồng Escape";
    ...
    private void loadDatabase() {
        ...
        try (Connection con = DBService.gI().getConnectionForGame();) {
            ...
            File folder = new File("resources/louisgoku/data_lucky_round_reward");
            ...
            // load reward mob
            folder = new File("resources/louisgoku/data_mob_reward");
            for (File fileEntry : folder.listFiles()) {
                if (!fileEntry.isDirectory()) {
    ...
    private int[][] readTileIndexTileType(int tileTypeFocus) {
        ...
        try {
            DataInputStream dis = new DataInputStream(new FileInputStream("resources/louisgoku/map/tile_set_info"));
