...
//        player.effectSkill.timeAnTroi = timeAnTroi;
    ...
    public void setIsBienHinh(Player player) {
        ...
        int timeBienHinh = SkillUtil.getTimeBienHinh(player.playerSkill.skillSelect.point);
        if (player.setClothes.cadic == 5) {
            timeBienHinh *= 5;
        }
        player.effectSkill.isBienHinh = true;
        player.effectSkill.timeBienHinh = 10000;
        player.effectSkill.lastTimeUpBienHinh = System.currentTimeMillis();
